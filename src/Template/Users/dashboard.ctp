			...
			<div class="box">
				<div class="row row-offcanvas row-offcanvas-left">
					...
					<div class="column col-sm-0 col-xs-0" id="main">
						...
						<!-- top nav -->
						<div class="navbar navbar-blue navbar-static-top" style="width:100% !important">  
							<div class="navbar-header">
							  <button class="navbar-toggle" type="button" data-toggle="collapse" data-target=".navbar-collapse" width=100%>
								...
								<div class="row">
								 ...
								 <div class="col-sm-5">
									  ...
									  <div class="panel panel-default">
										<div class="panel-thumbnail"><img src="localhost/DummyFB/bg_5.jpg" class="img-responsive"></div>
