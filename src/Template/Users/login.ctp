...
<div class="loginbox radius">
  ...
  <div class="loginboxinner radius">
    <div class="loginheader">
      <h4 class="title">Connect with friends and the world around you.</h4><br>
      <?= $this->Flash->render() ?>
    </div>
    <div class="loginform">
    <div class='users form'>
      ...
      <fieldset style="float:left;">
        <legend><?= _("Please enter email and password") ?></legend><br>
...
width: 208px; margin-top:21px;")) ?>
      ...
      <input type="button" style="float: inherit; width: 208px; margin-top: 21px; height: 52px; background: #5870A8 none repeat scroll 0% 0%; border:1px solid" name="signup"><a href="/DemoProject/users/add" style="margin: 0px 0px 0px -138px; font-size: 18px; color: white;">Sign Up</a></input>
  </div>
</div>